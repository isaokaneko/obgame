...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Obgame05", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Obgame05", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Obgame05";
		app.meta["name"] = "Obgame05";
		app.meta["packageName"] = "com.sample.obgame05";
